...
export class RssFeedDetailsComponent implements OnInit, OnDestroy
{
    ...
    updateContact(): void
    {
        ...
        this._rssFeedService.updateContact(contact.id, contact).subscribe(() => {
    ...
    deleteContact(): void
    {
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if ( result === 'confirmed' )
            {
                ...
                // Delete the contact
                this._rssFeedService.deleteContact(id)
                    .subscribe((isDeleted) => {
    ...
    uploadAvatar(fileList: FileList): void
    {
        ...
        // Upload the avatar
        this._rssFeedService.uploadAvatar(this.contact.id, file).subscribe();
    }
    ...
    createTag(title: string): void
    {
        ...
        this._rssFeedService.createTag(tag)
            .subscribe((response) => {
    ...
    updateTagTitle(tag: Tag, event): void
    {
        ...
        this._rssFeedService.updateTag(tag.id, tag)
    ...
    deleteTag(tag: Tag): void
    {
        ...
        this._rssFeedService.deleteTag(tag.id).subscribe();
